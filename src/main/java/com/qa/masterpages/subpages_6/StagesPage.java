...
public class StagesPage extends TestBase {
	...
	@FindBy(xpath= "//a[normalize-space()='Stages']")
	WebElement Stages_menu;
	...
	@FindBy(xpath= "//span[normalize-space()='Stages already exists']")
