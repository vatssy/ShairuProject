...
public class DeBeersBandPage extends TestBase {
	...
	@FindBy(xpath= "//a[normalize-space()='De Beers Band']")
	WebElement DeBeersBand_menu;
	...
	@FindBy(xpath= "//span[normalize-space()='Band Name already exists']")
