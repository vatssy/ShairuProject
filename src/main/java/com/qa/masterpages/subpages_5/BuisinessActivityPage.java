...
public class BuisinessActivityPage extends TestBase {
	...
	@FindBy(xpath= "//a[normalize-space()='Business Activity']")
	WebElement BusinessActivity_menu;
	...
	@FindBy(xpath= "//span[normalize-space()='Business Activity already exists']")
