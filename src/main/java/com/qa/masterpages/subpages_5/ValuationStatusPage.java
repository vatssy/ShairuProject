...
public class ValuationStatusPage extends TestBase {
	...
	@FindBy(xpath= "//a[normalize-space()='Valuation Status']")
	WebElement ValuationStatus_menu;
	...
	@FindBy(xpath= "//span[normalize-space()='Valuation Status already exists']")
