...
public class GoodTypePage extends TestBase {
	...
	@FindBy(xpath= "//a[normalize-space()='Goods Type']")
	WebElement GoodsType_menu;
	...
	@FindBy(xpath= "//span[normalize-space()='Goods Name already exists']")
