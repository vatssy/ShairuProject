...
public class FormatPage extends TestBase {
	...
	@FindBy(xpath= "//a[normalize-space()='Format']")
	WebElement Format_menu;
	...
	@FindBy(xpath= "//span[normalize-space()='Format Name already exists']")
