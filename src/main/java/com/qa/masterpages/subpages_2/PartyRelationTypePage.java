package com.qa.masterpages.subpages_2;
...
public class PartyRelationTypePage extends TestBase {
	...
	@FindBy(xpath= "//a[normalize-space()='Party Relation Type']")
	WebElement PartyRelation_menu;
	...
	@FindBy(xpath= "//span[normalize-space()='Party Relation Type already exists']")
