...
public class PartySubCategoryPage extends TestBase {
	...
	@FindBy(xpath= "//a[normalize-space()='Party Sub Category']")
	WebElement PartySubCategory_menu;
	...
	@FindBy(xpath= "//span[normalize-space()='Sub Category already exists']")
