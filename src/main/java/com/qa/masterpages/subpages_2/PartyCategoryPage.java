...
public class PartyCategoryPage extends TestBase {
	...
	@FindBy(xpath= "//a[normalize-space()='Party Category']")
	WebElement PartyCategory_menu;
	...
	@FindBy(xpath= "//span[normalize-space()='Category already exists']")
