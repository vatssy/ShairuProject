...
public class BankDetialPage extends TestBase {
	...
	@FindBy(xpath= "//a[normalize-space()='Bank Detail']")
	WebElement BankDetail_menu;
	...
	@FindBy(xpath= "//span[normalize-space()='Bank name already exists']")
