...
public class MiningPage extends TestBase {
	...
	@FindBy(xpath= "//a[normalize-space()='Mining']")
	WebElement Mining_menu;
	...
	WebElement data1_inputfield;
	@FindBy(xpath= "(//input[@type='text'])[2]")
	WebElement data2_inputfield;
	...
	@FindBy(xpath= "//span[normalize-space()='Mining already exists']")
	...
	{
		data1_inputfield.sendKeys(Common_No_random);
		data2_inputfield.sendKeys(Common_No_random);
		try {
