...
public class DocumentDetialsTypePage extends TestBase {
	...
	@FindBy(xpath= "//a[normalize-space()='Document Details Type']")
	WebElement DocumentDetails_menu;
	...
	@FindBy(xpath= "/html/body/div[1]/div/section/section/main/div/div/div[2]/div/div/div/div/div/table/tbody/tr[2]/td[6]/div/div[1]/a/span/svg")
	...
	@FindBy(xpath= "/html/b/html/body/div[4]/div/div/div/div/div/span[2]")
	...
	public DocumentDetialsTypePage()
	{
		PageFactory.initElements(driver, this);
	}
	
	
	public void Navigate_DocumentDetials_menu() 
	{
		try {
			//TestUtil.navigate_to_option1(Master_menu,Occupation_menu);
			Thread.sleep(3000);
			DocumentDetails_menu.click();
