...
public class AccountTypePage extends TestBase {
	...
	@FindBy(xpath= "//a[normalize-space()='Account Type']")
	WebElement Accounttype_menu;
	...
	@FindBy(xpath= "//span[normalize-space()='Account Type already exists']")
