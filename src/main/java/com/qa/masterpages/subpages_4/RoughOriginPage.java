...
public class RoughOriginPage extends TestBase {
	...
	@FindBy(xpath= "//a[normalize-space()='Rough Origin']")
	WebElement RoughOrigin_menu;
	...
	@FindBy(xpath= "//span[normalize-space()='Origin already exists']")
