...
public class ExpenseTypePage extends TestBase {
	...
	@FindBy(xpath= "//a[normalize-space()='Expense Type']")
	WebElement ExpenseType_menu;
	...
	@FindBy(xpath= "//span[normalize-space()='Expense Type already exists']")
