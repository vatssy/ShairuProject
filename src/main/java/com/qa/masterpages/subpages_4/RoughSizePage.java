...
public class RoughSizePage extends TestBase {
	...
	@FindBy(xpath= "//a[normalize-space()='Rough Size']")
	WebElement RoughSize_menu;
	...
	@FindBy(xpath= "//span[normalize-space()='Rough size already exists']")
