...
public class ExchangeTypePage extends TestBase {
	...
	@FindBy(xpath= "//a[normalize-space()='Exchange Type']")
	WebElement ExchangeType_menu;
	...
	@FindBy(xpath= "//span[normalize-space()='Exchange type already exists']")
