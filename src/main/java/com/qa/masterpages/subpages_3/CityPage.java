...
public class CityPage extends TestBase {
	...
	@FindBy(xpath= "//a[normalize-space()='City']")
	WebElement City_menu;
	...
	@FindBy(xpath= "//span[normalize-space()='City already exists']")
	...
	public void add_data_record()
	{
		...
		String actual_text = driver.findElement(By.xpath("//tr[@class='ant-table-row ant-table-row-level-0 editable-row']//td[5]")).getText();
		try {
			Thread.sleep(5000);
		} catch (InterruptedException e) {
			// TODO Auto-generated catch block
