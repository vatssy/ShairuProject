...
public class TransactionTypePage extends TestBase {
	...
	@FindBy(xpath= "//a[normalize-space()='Transaction Type']")
	WebElement TransactionType_menu;
	...
	@FindBy(xpath= "//span[normalize-space()='Transaction type already exists']")
